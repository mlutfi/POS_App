      ...
      <ScrollArea className="max-h-[300px]">
        <div className="space-y-2 pr-2">
          {items.map((item) => (
            ...
            >
              {/* Color dot */}
              <div className="h-8 w-1.5 rounded-full bg-gradient-to-b from-orange-400 to-amber-500 shrink-0" />
              ...
              <div className="flex items-center gap-1 shrink-0">
                ...
                <button
                  onClick={() => onSetQty(item.productId, item.qty + 1)}
                  className="flex h-6 w-6 items-center justify-center rounded-lg bg-orange-500 text-white shadow-sm shadow-orange-200 transition-all hover:bg-orange-600 active:scale-90"
                >
